 ...
 input:focus:invalid {
  ...
  input:focus + .help {
	...
	<body>
		...
		<fieldset>
		<legend style="background:pink;text-align:center;color:black;">Add Students</legend>
		<label class="label label-default">Roll :</label>
		<input id="roll" class="form-control" name="userroll" placeholder="Enter Roll" type="text" maxlength="7" ><br/>
		<label class="label label-default">Name :</label>
		<input id="name" class="form-control" name="username" placeholder="Enter Name" type="text" ><br/>
		<label class="label label-default">Mobile :</label>
		<input id="mobile" class="form-control" name="usermobile" placeholder="Enter Mobile no" type="text" maxlength="11"><br/>
		...
		<input id="email" class="form-control" name="useremail" type="email"><br/>
		<input style="margin-left:450px;width:150px;" class="btn btn-primary btn-lg" name="submit" type="submit" value=" Add ">
