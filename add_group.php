...
<div>
     	<form action="add_group.php" method="post">
			  <fieldset>
<legend style="background:pink;text-align:center;color:black">Add Groups</legend>
					            <input type="text" name="roll1" class="roll1" placeholder="Enter Roll" maxlength="7" ><br/>
                      <input type="text" name="roll2" class="roll2" placeholder="Enter Roll" maxlength="7"><br/>
                      <input type="text" name="roll3" class="roll3" placeholder="Enter Roll" maxlength="7"><br/>
                      <input type="text" name="roll4" class="roll4" placeholder="Enter Roll" maxlength="7"><br/>
                      <input type="text" name="roll5" class="roll5"placeholder="Enter Roll" maxlength="7"><br/>
				    ...
				    <input style="margin-left:300px;" name="Group" type="submit" value="ADD">
			  </fieldset>
			</form>
	    </div>
</body>
